...
import Banner from '../../assets/roma.jpg';
import Banner1 from '../../assets/banner1.jpg';
import Coca from '../../assets/coca.jpg';
import CardParcel from '../../components/CardParcel/CardParcel';
    ...
    return (
        <div>
            ...
            <div className="banner1">
                <h1>Pilihan Parcel Kami Untukmu</h1>
                <div className="row1">
                    <Row1 />
                </div>
            </div>
